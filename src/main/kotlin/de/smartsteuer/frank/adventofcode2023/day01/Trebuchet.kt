...
fun main() {
  ...
  part1(calibrationInput)
  part2(calibrationInput)
}

internal fun part1(calibrationInput: List<String>): Int {
  val calibrationValues = calibrationInput.map { calibrationValue(it, toDigits) }
...
internal fun part2(calibrationInput: List<String>): Int {
  val calibrationValues = calibrationInput.map { calibrationValue(it, toDigitsIncludingText) }
  val sum = calibrationValues.sum()
